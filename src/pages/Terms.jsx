      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <section className="space-y-12 text-slate-300 leading-relaxed">
          <div className="glass-card p-8 md:p-12">
            ...
            <p>Reservations at CAFENOIR are held for a maximum of 15 minutes past the scheduled time. Late arrivals may result in a forfeited table or a shift to our waitlist.</p>
          </div>
          ...
          <div>
            ...
            <p>All digital assets, code (including the "Boxes" background and "Magnetic" interaction scripts), and culinary designs are the exclusive property of CAFENOIR. Unauthorized replication is prohibited.</p>
          </div>
          ...
          <div className="bg-primary/5 border border-primary/20 p-6 rounded-2xl">
             ...
             <p className="text-sm text-slate-400 italic">CAFENOIR provides this digital platform "as is." We are not liable for any digital interruptions or inaccuracies in real-time kitchen status displays.</p>
          </div>
        </section>
      </div>
    </main>
