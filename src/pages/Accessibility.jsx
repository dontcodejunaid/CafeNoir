    ...
    <main className="pt-32 pb-24 bg-bg-main min-height-screen">
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <section className="text-slate-300">
          ...
          <p>If you encounter any barriers on our platform, please reach out to our experience designers at <span className="text-primary">accessibility@cafenoir.com</span>. We treat accessibility feedback as a priority bug.</p>
        </section>
      </div>
    </main>
  );
