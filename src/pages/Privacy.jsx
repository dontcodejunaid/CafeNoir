      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <section className="space-y-12 text-slate-300 leading-relaxed">
          ...
          <div>
            ...
            <p>CAFENOIR employs AES-256 encryption for all data at rest. Your personal information is treated as a premium asset, stored securely within our "Encrypted Experience Design" framework.</p>
          </div>
