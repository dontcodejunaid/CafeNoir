      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="glass-card p-8">
            ...
            <p className="text-slate-400 text-sm">Our Ramanagara venue on Mysore Road features ramp access, braille menus upon request, and adjustable lighting zones for guests with sensory sensitivities.</p>
          </div>
        </div>
        ...
        <section className="text-slate-300">
          ...
          <p>If you encounter any barriers on our platform, please reach out to our experience designers at <span className="text-primary">baigjunaid187@gmail.com</span>. We treat accessibility feedback as a priority bug.</p>
        </section>
      </div>
    </main>
  );
